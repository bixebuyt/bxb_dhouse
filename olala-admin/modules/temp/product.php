...
function product($act, $typeFunc, $product_id, $product_menu_id, $name, $img, $img_note, $product_keys, $price, $model, $sale, $comment, $content, $tech,$parameter,$other,$upload_img_id, $is_active, $hot, $pin, $created_time, $title, $description, $keywords, $error) {
	global $db, $tth;
				...
				<div class="table-respon">
					<form action="<?=$act?>" method="post" enctype="multipart/form-data">
						...
						<table class="table table-hover">
							...
							<tr>
								<td class="ver-top"><label>Tổng quan:</label></td>
								<td colspan="3">
									<textarea class="form-control" id="content" name="content"><?=stripslashes($content)?></textarea>
								</td>
							</tr>
							<tr>
								<td class="ver-top"><label>Công nghệ:</label></td>
								<td colspan="3">
									<textarea class="form-control" id="tech" name="tech"><?=stripslashes($tech)?></textarea>
								</td>
							</tr>
								<tr>
								<td class="ver-top"><label>Thông số kĩ thuật:</label></td>
								<td colspan="3">
									<textarea class="form-control" id="parameter" name="parameter"><?=stripslashes($parameter)?></textarea>
								</td>
							</tr>
							<tr>
								<td class="ver-top"><label>Thông tin khác:</label></td>
								<td colspan="3">
									<textarea class="form-control" id="other" name="other"><?=stripslashes($other)?></textarea>
								</td>
							</tr>
							<tr>
